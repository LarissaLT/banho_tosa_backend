-- Inserção de dados
INSERT INTO Tutor (nome, telefone, email, endereco, senha, role) VALUES ('Maria', '123456789', 'maria@example.com', 'Rua A, 123', 'trocar_senha','USER'),
                                                           ('Ana', '11122233344', 'ana@example.com', 'Rua B, 456', 'trocar_senha','USER');
